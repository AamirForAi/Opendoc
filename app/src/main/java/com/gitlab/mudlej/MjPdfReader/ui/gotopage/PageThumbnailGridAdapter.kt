...
import com.gitlab.mudlej.MjPdfReader.databinding.ItemPageThumbnailGridBinding
import com.gitlab.mudlej.MjPdfReader.pdf.PageThumbnailCache
import kotlinx.coroutines.Job

class PageThumbnailGridAdapter(
    ...
    class ViewHolder(val binding: ItemPageThumbnailGridBinding) : RecyclerView.ViewHolder(binding.root) {
